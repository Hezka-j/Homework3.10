...
void SetCursor(double arr[], int n)
{
    for (int i = 0; i < n; i++)
    {
        arr[i] = rand() / 10.0;
...
void SetCursor(int arr[], int n)
{
    for(int i = 0; i < n; i++)
        cout << arr[i];
}
void SetCursor(int arr[][80], int height, int width, string str)
{
    cout << str;
...
int SetCursor(int arr[][80], int height, int width, int sum = 0)
{
